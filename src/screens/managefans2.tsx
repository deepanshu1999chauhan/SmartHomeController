...
const managefans2 = ({ navigation }: { navigation: any }) => {
   return (
            <View>
                <ImageBackground
                    style={style.image}
                    source={require('../images/fans2.png')}>
                    ...
                    <View style={style.container3}>
                        ...
                        <TouchableOpacity style={style.touchable}>
                            <Text style={style.text3}>27 kw</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={style.lightcontainer2}>
                        ...
                        onPress={() => navigation.replace('managefans')}
                        >
                            <Image
                                style={style.light}
